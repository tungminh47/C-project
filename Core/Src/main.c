...
int counter = 1000;
volatile GPIO_PinState PinState = GPIO_PIN_RESET;
/* USER CODE END PV */
...
void HAL_TIM_PeriodElapsedCallback(TIM_HandleTypeDef *htim){
	...
	if(htim->Instance == TIM4){
		...
		__HAL_TIM_SET_AUTORELOAD(&htim4, timerPeriod - 1);
	}
}
	...
	if (huart->Instance == USART1)
	  {
	    ...
	    {
	      timerPeriod = 500;
	      char *msg = "Timer set to 0.5 second\r\n";
	      HAL_UART_Transmit(&huart1, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
	    }
	    else if (rxData == '2')
	    {
	      timerPeriod = 1000;
	      char *msg = "Timer set to 1 second\r\n";
	      HAL_UART_Transmit(&huart1, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
	    }
	    else if (rxData == '3')
	    {
	      timerPeriod = 2000;
	      char *msg = "Timer set to 2 seconds\r\n";
	      HAL_UART_Transmit(&huart1, (uint8_t*)msg, strlen(msg), HAL_MAX_DELAY);
	    }
